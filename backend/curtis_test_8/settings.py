"""
Django settings for curtis_test_8 project.
...
ROOT_URLCONF = 'curtis_test_8.urls'
...
WSGI_APPLICATION = 'curtis_test_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_test_8 API",
    "DESCRIPTION": "API documentation for curtis_test_8 App",
    "VERSION": "v1",
}
